...
mpv_command '{"command":["set_property","cache",true]}'
mpv_command '{"command":["set_property","demuxer-readahead-secs",1]}'
mpv_command '{"command":["vf","set","fps=15"]}'
mpv_command "{\"command\":[\"loadfile\",\"${default_video}\",\"replace\"]}"
